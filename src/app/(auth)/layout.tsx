      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <div className="inline-flex items-center gap-2 mb-2">
            ...
            <span className="text-xl font-bold text-white tracking-tight">Spreetail</span>
          </div>
          <p className="text-gray-500 text-sm">Split expenses fairly with your flatmates</p>
        </div>
        {children}
      </div>
    </div>
